...
Aqui encontram-se os requisitos do projeto. Em cada requisito você encontrará uma imagem de um protótipo de como sua aplicação deve ficar. Estilo da página não será avaliado.
